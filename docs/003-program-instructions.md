...
| Name | Type | Description |
|---|---|---|
| `recipients` | `DistributionRecipients` | Splits preimage (`count(u32 LE) || [recipient(32) || shareBps(u16 LE)] × count`). Rehashed on-chain; Blake3 digest must equal `Channel.distribution_hash`. |
