...
export const PAYMENT_CHANNELS_ERROR__ADDRESS_MISMATCH = 0x24; // 36
export const PAYMENT_CHANNELS_ERROR__DUPLICATE_TOKEN_EXTENSION = 0x25; // 37
...
export type PaymentChannelsError =
  ...
  | typeof PAYMENT_CHANNELS_ERROR__DUPLICATE_TOKEN_EXTENSION
...
if (process.env["NODE_ENV"] !== "production") {
  paymentChannelsErrorMessages = {
    ...
    [PAYMENT_CHANNELS_ERROR__DUPLICATE_TOKEN_EXTENSION]: `Token-2022 TLV trailer contains a duplicate extension entry`,
