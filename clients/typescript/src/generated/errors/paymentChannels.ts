...
export const PAYMENT_CHANNELS_ERROR__DUPLICATE_RECIPIENT = 0x20; // 32
...
export const PAYMENT_CHANNELS_ERROR__MINT_ADDRESS_MISMATCH = 0x23; // 35
export const PAYMENT_CHANNELS_ERROR__UNAUTHORIZED_MERCHANT = 0x24; // 36
export const PAYMENT_CHANNELS_ERROR__MALFORMED_TOKEN_ACCOUNT_DATA = 0x25; // 37
...
export type PaymentChannelsError =
  ...
  | typeof PAYMENT_CHANNELS_ERROR__MALFORMED_TOKEN_ACCOUNT_DATA
  | typeof PAYMENT_CHANNELS_ERROR__MINT_ACCOUNT_MISMATCH
  | typeof PAYMENT_CHANNELS_ERROR__MINT_ADDRESS_MISMATCH
  ...
  | typeof PAYMENT_CHANNELS_ERROR__UNAUTHORIZED_MERCHANT
...
if (process.env["NODE_ENV"] !== "production") {
  paymentChannelsErrorMessages = {
    ...
    [PAYMENT_CHANNELS_ERROR__MALFORMED_TOKEN_ACCOUNT_DATA]: `Token account or mint TLV trailer is malformed`,
    [PAYMENT_CHANNELS_ERROR__MINT_ACCOUNT_MISMATCH]: `Mint account does not match channel.mint`,
    [PAYMENT_CHANNELS_ERROR__MINT_ADDRESS_MISMATCH]: `Mint account does not match channel's recorded mint`,
    ...
    [PAYMENT_CHANNELS_ERROR__UNAUTHORIZED_MERCHANT]: `Caller is not the channel payee`,
