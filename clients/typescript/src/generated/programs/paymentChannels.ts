...
export function identifyPaymentChannelsInstruction(
  ...
  if (containsBytes(data, getU8Encoder().encode(8), 0)) {
    return PaymentChannelsInstruction.WithdrawPayee;
  }
...
export type ParsedPaymentChannelsInstruction<
  TProgram extends string = "GuoKrzaBiZnW5DvJ3yZVE7xHqbcBvaX9SH6P6Cn9gNvc",
> =
  | ({
  ...
  | ({
      instructionType: PaymentChannelsInstruction.WithdrawPayee;
    } & ParsedWithdrawPayeeInstruction<TProgram>)
  | ({
...
export function parsePaymentChannelsInstruction<TProgram extends string>(
  ...
  switch (instructionType) {
    ...
    case PaymentChannelsInstruction.WithdrawPayee: {
      assertIsInstructionWithAccounts(instruction);
      return {
        instructionType: PaymentChannelsInstruction.WithdrawPayee,
        ...parseWithdrawPayeeInstruction(instruction),
      };
    }
...
export type PaymentChannelsPluginInstructions = {
  ...
  ) => ReturnType<typeof getWithdrawPayeeInstruction> &
    SelfPlanAndSendFunctions;
  emitEvent: (
      ...
      paymentChannels: <PaymentChannelsPlugin>{
        ...
        instructions: {
          ...
          withdrawPayee: (input) =>
            addSelfPlanAndSendFunctions(
              client,
              getWithdrawPayeeInstruction(input),
            ),
          emitEvent: (input) =>
            addSelfPlanAndSendFunctions(
              client,
